...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF313866);
  late Color secondary = const Color(0xFF504099);
  late Color tertiary = const Color(0xFF974EC3);
  late Color alternate = const Color(0xFFFE7BE5);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xA7FFFFFF);
